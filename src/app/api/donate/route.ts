...
import {
  ...
  export async function GET(request: Request) {
    ...
    const payload: ActionGetResponse = {
      ...
      icon: "https://media.graphassets.com/ndAekm8PT3WTmfaSddcR", // Icon URL
      title: "Donate me", // Title
      description: "Support me by donating SOL.", // Description
  ...
  export async function POST(request: Request) {
    ...
    const transaction = new Transaction().add(
      SystemProgram.transfer({
        ...
        toPubkey: new PublicKey("FPMpAfnyApbWFETSo7S3iHapR9pLNTKJNXVQ41pQFfFE"), // Recipient public key
